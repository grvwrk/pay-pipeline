...
# 1. Guardrails
write('backend/app/guardrails/spend_limiter.py', '''from typing import Dict
...
write('backend/app/guardrails/idempotency.py', '''from typing import Dict, Optional, Any
import datetime
...
write('backend/app/guardrails/policy_engine.py', '''import uuid
...
print("Guardrails written successfully!")
